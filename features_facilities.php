      ...
      <div class="container-fluid" id="main-content"> 
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden ">
              <h3 class="mb-4 h-font">Features & Facilities</h3>  
     
              <div class="card border-0 shadow mb-4">
                  <div class="card-body ">
                       
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="card-title m-0 h-font">Features</h5>
              ...
              <div class="card border-0 shadow mb-4"> 
                  <div class="card-body ">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="card-title m-0 h-font">Fcilities</h5>
                  ...
                  <form id="feature_s_form">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title h-font">Add Feature</h5>
                      </div>
        ...
        <div class="modal fade" id="facility-s" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <form id="facility_s_form">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title h-font">Add Facility</h5>
                      </div>
                      <div class="modal-body">
                        <div class=" mb-3">
                        ...
                        <div class="mb-3" >
                            ...
                            <textarea name="facility_desc" class="form-control"rows="4"></textarea>
                        </div>
