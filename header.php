  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand me-5 fw-bold fs-3 " href="index.php">Hotel North South</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                    <a class="nav-link active me-2 h-font" aria-current="page" href="index.php">Home</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link me-2 h-font" href="#">Rooms</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link me-2 h-font" href="facilities.php">Facilitis</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link me-2 h-font" href="#">Contract Us</a>
                    </li>
                    <li class="nav-item">
