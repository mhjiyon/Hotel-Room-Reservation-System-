     <?php
        ...
        define('SITE_URL','http://127.0.0.1/hotel_north_south/');
        ...
        // for backend
        define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/Hotel_North_South/image/');
...
test;
        ...
        function deleteImage($image,$folder){
            ...
            //     return true;
            // }
            unlink(UPLOAD_IMAGE_PATH.$folder.$image);
            return true;
        }
