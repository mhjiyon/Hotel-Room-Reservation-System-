...
<h6 class="text-center bg-dark text-white p-3 m-0 ">Designed and devloped by M H Jiyon</h6>
  ...
  function alert(type,msg,position='body'){
      ...
      element.innerHTML =`
          <div class="alert ${bs_class}  alert-dismissible fade show " role="alert">
              <strong class="me-3 h-font"> ${msg} </strong> 
    ...
    let xhr = new XMLHttpRequest();
      ...
      xhr.onload =function(){
          if(this.responseText=='pass_mismatch'){
            ...
            alert('error',"Image Uplode Failed");
          }
          else if(this.responseText=='ins_faild'){
            alert('error',"Insert Faild");
          }
          else{
    ...
    let xhr = new XMLHttpRequest();
      ...
      xhr.onload =function(){
          if(this.responseText=='inv_email_mobile'){
            ...
            alert('error',"Didn't verified your account");
          }
          else if(this.responseText=='User_Blocked'){
            alert('error',"Blocked By Admin");
          }
